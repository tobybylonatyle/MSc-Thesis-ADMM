...
class ALRModel(pyo.AbstractModel):
    ...
    def __build_parameters(self):
        ...
        self.dualgamma = pyo.Param(self.T, within=pyo.Reals, mutable= True, default=1) # Additonla penalty term
    ...
    def __build_objective(self):
        self.Objective_Cost = pyo.Objective(rule=aux.cost_ALR_full, sense=pyo.minimize) 
